...
class Plugin(ExtractionPlugin):
    ...
    def plugin_info(self):
        plugin_info = PluginInfo(
            id=PluginId(domain='politie.nl', category='crypto', name='hansen-coinbase'),
            version='1.0.0',
            description='Parses coinbase wallet produced by Coinbase app on iOS/Android',
            ...
            matcher='org.toshi.distribution.plist AND $data.type=raw',  # add the query for the types of traces your plugin should match
